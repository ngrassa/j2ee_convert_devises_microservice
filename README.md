# Convertisseur TND en microservices (Tomcat 9)
...
- Script d’aide: `ubuntu25-setup.sh` installe Java 17/ Maven/ Docker; adaptez si besoin pour Java 21.
...
## Démarrage rapide
```bash
./ubuntu25-setup.sh   # optionnel : installe Java/Maven/Docker sur Ubuntu 25.04 (sudo)
...
- API converter : http://localhost:9082/api/convert?amount=100&to=EUR
...
## Tests rapides
- Taux: `curl http://localhost:8081/api/rates`
- Conversion: `curl "http://localhost:8082/api/convert?amount=100&to=EUR"`
